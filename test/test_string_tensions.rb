...
class StringTensionsTest < Test::Unit::TestCase
  ...
  def test_uw_accepts_unit_params
    ex = ::Unit.new("0.000014207788554264654 lbs/in")
    res = StringTensions.uw_for_pitch("10.4 lbf", "25.5 in", "e'")
    assert_equal 'lbs/in', res.units
    assert_equal ex, res
  end
  ...
  def test_uw_autoconverts_units
    ...
    res = StringTensions.uw_for_pitch("4.71736 N", "25.5 in", "e'")
    assert_equal 'lbs/in', res.units
  ...
  def test_tension_from_density_and_gauge
    ...
    res = StringTensions.tension_for_pitch(StringTensions.uw_from_density("1300 kg/m^3", "0.5 mm"), "650 mm", "a'").to('N')
